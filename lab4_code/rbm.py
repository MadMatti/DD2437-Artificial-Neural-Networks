...
class RestrictedBoltzmannMachine():
    ...
    def cd1(self,visible_trainset, n_iterations=10000):
        ...
        self.losses = []
        self.delta_weight_vh_mean = []
        self.delta_bias_v_mean = []
        self.delta_bias_h_mean = []
        ...
        for iteration in range(n_iterations):
            ...
            if iteration % self.rf["period"] == 0 and self.is_bottom:
                viz_rf(weights=self.weight_vh[:, self.rf["ids"]].reshape((self.image_size[0], self.image_size[1], -1)), it=iteration, grid=self.rf["grid"])
            ...
            self.delta_bias_v_mean.append(np.mean(self.delta_bias_v))
            self.delta_bias_h_mean.append(np.mean(self.delta_bias_h))
